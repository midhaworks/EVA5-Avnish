...
def create_modules(module_defs, img_size):
    ...
    yolo_index = -1
    resnext = _make_pretrained_resnext101_wsl(True)
    ...
    for i, mdef in enumerate(module_defs):
        ...
        if mdef['type'] == 'convolutional':
            ...
            in_channels = mdef['in_channels'] if 'in_channels' in mdef else output_filters[-1]
            bias = mdef['bias'] if 'bias' in mdef else (not bn)
            # if no activation or batch normalization, just add the Conv2d as single module (not sequential model)
        ...
        elif mdef['type'] == 'resnext101_layer1':
            modules = resnext.layer1
            filters = mdef['filters']

        elif mdef['type'] == 'resnext101_layer2':
            modules = resnext.layer2
            filters = mdef['filters']

        elif mdef['type'] == 'resnext101_layer3':
            modules = resnext.layer3
            filters = mdef['filters']

        elif mdef['type'] == 'resnext101_layer4':
            modules = resnext.layer4
            filters = mdef['filters']

        elif mdef['type'] == 'midasdecoder':
            modules = MidasDecoder(features = mdef['features'], non_negative = mdef['non_negative'])
            filters = mdef['filters']
...
class Darknet(nn.Module):
    ...
    def forward_once(self, x, augment=False, verbose=False):
        ...
        for i, module in enumerate(self.module_list):
            ...
            elif name == 'resnext101_layer1':
                x = module(x)

            elif name == 'resnext101_layer2':
                x = module(x)

            elif name == 'resnext101_layer3':
                x = module(x)

            elif name == 'resnext101_layer4':
                x = module(x)

            else:  # run module directly, i.e. mtype = 'convolutional', 'upsample', 'maxpool', 'batchnorm2d', 'layer1', 'layer2' etc.
                x = module(x)
    ...
    def load_weights(self, preloaded_midasnet, preloaded_yolov3):
        ...
        self.module_list[23].load_state_dict(preloaded_yolov3.module_list[86].state_dict())
        self.module_list[24].load_state_dict(preloaded_yolov3.module_list[87].state_dict())
        self.module_list[25].load_state_dict(preloaded_yolov3.module_list[88].state_dict())
        self.module_list[26].load_state_dict(preloaded_yolov3.module_list[89].state_dict())
        ...
        self.module_list[34].load_state_dict(preloaded_yolov3.module_list[97].state_dict())
        self.module_list[35].load_state_dict(preloaded_yolov3.module_list[98].state_dict())
        self.module_list[36].load_state_dict(preloaded_yolov3.module_list[99].state_dict())
        self.module_list[37].load_state_dict(preloaded_yolov3.module_list[100].state_dict())
        self.module_list[38].load_state_dict(preloaded_yolov3.module_list[101].state_dict())
        self.module_list[39].load_state_dict(preloaded_yolov3.module_list[102].state_dict())
        self.module_list[40].load_state_dict(preloaded_yolov3.module_list[103].state_dict())
        self.module_list[41].load_state_dict(preloaded_yolov3.module_list[104].state_dict())
        self.module_list[42].load_state_dict(preloaded_yolov3.module_list[105].state_dict())
        self.module_list[43].load_state_dict(preloaded_yolov3.module_list[106].state_dict())
        self.module_list[44].load_state_dict(preloaded_yolov3.module_list[107].state_dict())
        self.module_list[45].load_state_dict(preloaded_yolov3.module_list[108].state_dict())
        self.module_list[46].load_state_dict(preloaded_yolov3.module_list[109].state_dict())
        self.module_list[47].load_state_dict(preloaded_yolov3.module_list[110].state_dict())
        self.module_list[48].load_state_dict(preloaded_yolov3.module_list[111].state_dict())
        self.module_list[49].load_state_dict(preloaded_yolov3.module_list[112].state_dict())
